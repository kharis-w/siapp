...
elseif ($act == "adddatapegawai") {
    ...
    if ($result == 0) {
        $log1 = "INSERT INTO m_pgw (id_pgw, nama_pgw, nip_pgw, pangkat_pgw, jabatan_pgw, unit_kerja_pgw, no_telpn_pgw, alamat_pgw, img_pgw) VALUES ('" . $id_pgw . "','" . $nama_pgw . "','" . $nip_pgw . "','" . $pangkat_pgw . "','" . $jabatan_pgw . "','" . $unit_kerja_pgw . "','" . $no_telpn_pgw . "','" . $alamat_pgw . "','" . $img_pgw . "')";
