        ...
        <table border="0" cellspacing="0" class="table table-hover table-bordered" id="dataTable" width="100%">
          ...
          <tbody>
            ...
            <tr id="row<?php echo $no; ?>">
              ...
              <td>
                <button class="btn btn-warning btn-circle" title="Edit" onclick="editData('<?php echo $data['id_item'];?>')"><i class="fas fa-pen fa-lg"></i></button>

                <button class="btn btn-danger btn-circle" title="Delete"onclick="delData('<?php echo $data['id_item']; ?>','<?php echo $no;?>')"><i class="fas fa-trash fa-lg"></i></button>
              </td>
            </tr>
            <?php
                  $no++;
